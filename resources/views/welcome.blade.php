...
<body class="bg-gray-200 font-sans leading-normal tracking-normal">
        ...
        <div class="container mx-auto flex flex-wrap items-center">
            <div class="flex w-full md:w-1/2 justify-center md:justify-start text-white font-extrabold">
                <a class="text-white no-underline hover:text-white hover:no-underline" href="#">
                    <img style="display: inline-block" src="https://seeklogo.com/images/V/villa-el-salvador-logo-E55573FFE9-seeklogo.com.png"
                        width="50px" height="auto">
                    <span style="display: inline-block" class="text-1xl pl-2"> Municipalidad Distrital de Villa el Salvador</span>
                </a>
            </div>
    ...
    <div class="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-24">
        ...
        <div class="flex flex-col w-full lg:w-1/2 justify-center items-start pt-12 pb-24 px-20">
            <p class="uppercase tracking-loose">SISTEMA DE COMPROBANTES DE PAGO</p>
            <h1 class="font-bold text-3xl my-4">SISCOM</h1>
            <p class="leading-normal mb-4">Permite llevar un registro detallado de los comprobantes de pago de la
            Muncipalidad Distrital de Villa el Salvador</p>
        ...
        <div class="w-full lg:w-1/2 lg:py-6 text-center">
            ...
            <img src="{{ asset('img/comprobado.png') }}" style="margin: 0 0 0 100px" width="50%" srcset="">
